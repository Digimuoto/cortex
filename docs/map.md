...
| Downstream consumer binding | [Consumers/{consumer}/](Consumers/) | Long-term per consumer | No |
...
**Where does Portman-specific design belong?** Use `Consumers/Portman/`.
Portman can be the concrete example; Cortex architecture should still be
...
independent substrate and use Portman only as a downstream example.
