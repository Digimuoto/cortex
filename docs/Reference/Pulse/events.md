...
| -------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `run.claimed`                    | info     | Written atomically by the claim transaction. Details carry `queue_seconds` (pending wait before claim) for first claims; a requeued run (resumed after waiting) records `requeued: true` and omits `queue_seconds` — its requeue time is unknown without a pending-since column. Queue time and execution time are distinct clocks. |
