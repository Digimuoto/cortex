...
3. **SelectActualize integration** - connect the proof-side selected-arm actualization surface to
   executable runtime witnesses and durable recovery.
4. **Recovery determinism** - prove durable replay properties after the runtime record boundary is
