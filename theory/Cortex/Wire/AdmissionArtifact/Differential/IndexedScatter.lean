...
Differential oracle for the `IndexedScatter` fixture: the
...
namespace DifferentialIndexedScatter
...
/-- Accepted declaration for node `__star:scatter:c7ce4a38c306`. -/
def node1 : AcceptedNodeDecl where
  node := ⟨"__star:scatter:c7ce4a38c306"⟩
  nodeValid := by decide
  inputs := {⟨⟨"samples"⟩, ContractId.boundedIndexed ⟨"Sample"⟩ 3⟩}
  outputs :=
    [ .single ⟨⟨"workers_0"⟩, ⟨"Sample"⟩⟩
    , .single ⟨⟨"workers_1"⟩, ⟨"Sample"⟩⟩
    , .single ⟨⟨"workers_2"⟩, ⟨"Sample"⟩⟩
    ]
  inputPortsValid := by decide
  outputShapesAdmissible := by decide
  outputPortsListLabelsUnique := by decide
...
def node2 : AcceptedNodeDecl where
  node := ⟨"workers_0"⟩
  nodeValid := by decide
  inputs := {⟨⟨"workers_0"⟩, ⟨"Sample"⟩⟩}
  outputs := [.single ⟨⟨"workers_0"⟩, ⟨"Done"⟩⟩]
  inputPortsValid := by decide
  outputShapesAdmissible := by decide
  outputPortsListLabelsUnique := by decide
  inputLabelsUnique := by decide
...
def node3 : AcceptedNodeDecl where
  node := ⟨"workers_1"⟩
  nodeValid := by decide
  inputs := {⟨⟨"workers_1"⟩, ⟨"Sample"⟩⟩}
  outputs := [.single ⟨⟨"workers_1"⟩, ⟨"Done"⟩⟩]
  inputPortsValid := by decide
  outputShapesAdmissible := by decide
  outputPortsListLabelsUnique := by decide
  inputLabelsUnique := by decide
...
def node4 : AcceptedNodeDecl where
  node := ⟨"workers_2"⟩
  nodeValid := by decide
  inputs := {⟨⟨"workers_2"⟩, ⟨"Sample"⟩⟩}
  outputs := [.single ⟨⟨"workers_2"⟩, ⟨"Done"⟩⟩]
  inputPortsValid := by decide
  outputShapesAdmissible := by decide
  outputPortsListLabelsUnique := by decide
  inputLabelsUnique := by decide
...
def expr : GraphExpr :=
  .connect
      (.connect (.node ⟨"source"⟩) (.node ⟨"__star:scatter:c7ce4a38c306"⟩))
...
def expectedOutputs : Finset (SourcePortInstance NodeId OutputPortSignature) :=
  { ⟨⟨"workers_0"⟩, ⟨⟨⟨"workers_0"⟩, ⟨"Done"⟩⟩⟩⟩
  , ⟨⟨"workers_1"⟩, ⟨⟨⟨"workers_1"⟩, ⟨"Done"⟩⟩⟩⟩
  , ⟨⟨"workers_2"⟩, ⟨⟨⟨"workers_2"⟩, ⟨"Done"⟩⟩⟩⟩
  }
...
end DifferentialIndexedScatter
