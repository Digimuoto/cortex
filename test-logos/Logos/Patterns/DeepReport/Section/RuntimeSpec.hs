{- |
Module      : Logos.Patterns.DeepReport.Section.RuntimeSpec
Description : Tests for Logos.Patterns.DeepReport.Section.Runtime.
...
-}
module Logos.Patterns.DeepReport.Section.RuntimeSpec (spec) where
