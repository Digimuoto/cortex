{- |
Module      : Logos.Patterns.DeepReport.SectionSpec
Description : Tests for Logos.Patterns.DeepReport.Section.
...
-}
module Logos.Patterns.DeepReport.SectionSpec (spec) where
