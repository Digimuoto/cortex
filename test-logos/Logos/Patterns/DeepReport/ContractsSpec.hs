{- |
Module      : Logos.Patterns.DeepReport.ContractsSpec
Description : Tests for Logos.Patterns.DeepReport.Contracts.
...
spec :: Spec
spec =
  describe "Logos.Patterns.DeepReport.Contracts" $ do
    ...
    it "is exposed through the public Logos facade" $ do
      Logos.deepReportWireContractRegistry `shouldBe` deepReportWireContractRegistry
